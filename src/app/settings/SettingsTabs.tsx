...
const TABS: { name: string; items: Item[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/settings/email', title: 'Email (Klaviyo)', blurb: 'Connect Klaviyo - campaign opens, clicks and revenue', icon: '✉️' },
      { href: '/settings/inbox', title: 'Support inbox', blurb: 'Connect your support addresses, write macros', icon: '📥' },
      { href: '/settings/ai-support', title: 'Support assistant', blurb: 'What the AI may answer, and what it knows', icon: '🧠' },
    ],
  },
  {
    name: 'User',
